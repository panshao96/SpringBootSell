...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderDTO create(OrderDTO orderDTO) {
        ...
        for (OrderDetail orderDetail: orderDTO.getOrderDetailList()) {
            ...
            //2. 计算订单总价
            orderAmount = productInfo.getInfoPrice()
            ...
            orderDetail.setProductIcon(productInfo.getInfoIcon());
            orderDetail.setProductName(productInfo.getInfoName());
            orderDetail.setProductPrice(productInfo.getInfoPrice());
